...
public abstract class XboxController implements InputDevice {
    ...
    /**
     * Returns a list of all connected XboxControllers. On operating systems
     * other than Windows, the list may include devices other than Xbox 360
     * controllers.
     */
    ...
    /**
     * Listener to be notified when the controller's buttons or axes change
     * state.
     */
