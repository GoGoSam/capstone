 ...
 *
 */
public class MobileDirectionDisplayKeyboard extends JFrame
    ...
    private String dir_image_icons = System.getProperty("user.dir") + "/resources/xbox_controller_arrow_pics/";

    /**
     * Creates new form Controls_Display
     */
    public MobileDirectionDisplayKeyboard() {
        initComponents();
    ...
    private void initComponents() {
        ...
        icon_up.setIcon(new ImageIcon(dir_image_icons + "Arrow_up.jpg"));
        icon_up.setEnabled(false);

        icon_right.setIcon(new ImageIcon(dir_image_icons + "Arrow_right.jpg"));
        icon_right.setEnabled(false);

        icon_left.setIcon(new ImageIcon(dir_image_icons + "Arrow_left.jpg"));
        icon_left.setEnabled(false);

        icon_down.setIcon(new ImageIcon(dir_image_icons + "Arrow_down.jpg"));
        icon_down.setEnabled(false);
